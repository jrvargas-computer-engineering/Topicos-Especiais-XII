...
# Generated on: Thu Oct 09 00:31:44 -03 2025 (Thu Oct 09 03:31:44 UTC 2025)
...
set logfile fv/neuron_intra_Nbits/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/neuron_intra_Nbits -revised fv_map -use_rtl_names
...
read_library -liberty -both \
    /pdk/cadence/gpdk045/gsclib045_all_v4.4/gsclib045/timing/slow_vdd1v0_basicCells.lib \
    /pdk/cadence/gpdk045/gsclib045_all_v4.4/gsclib045/timing/slow_vdd1v0_multibitsDFF.lib \
    /pdk/cadence/gpdk045/gsclib045_all_v4.4/gsclib045/timing/slow_vdd1v0_extvdd1v0.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/neuron_intra_Nbits.v
elaborate_design -golden -root {neuron_intra_Nbits} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/neuron_intra_Nbits/fv_map.v.gz
elaborate_design -revised -root {neuron_intra_Nbits}
...
set_analyze_option -mapping_file fv/neuron_intra_Nbits/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.neuron_intra_Nbits.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.neuron_intra_Nbits.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.neuron_intra_Nbits.rtl.fv_map.rpt
