...
# Generated on: Wed Oct 08 22:20:10 -03 2025 (Thu Oct 09 01:20:10 UTC 2025)
...
set logfile fv/neuron_Nbits/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/neuron_Nbits -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/neuron_Nbits.v
elaborate_design -golden -root {neuron_Nbits} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/neuron_Nbits/fv_map.v.gz
elaborate_design -revised -root {neuron_Nbits}
...
add_black_box mac_Nbits_WIDTH8 ReLu_WIDTH8 -golden
...
set_analyze_option -mapping_file fv/neuron_Nbits/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.neuron_Nbits.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.neuron_Nbits.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.neuron_Nbits.rtl.fv_map.rpt
