...
// See neuron_wrapper_exact.h for the primary calling header
...
void sub___024root___eval_act(sub___024root* vlSelf) {
    ...
    neuron_wrapper_exact__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
#endif
                    VL_FATAL_MT("rtl/neuron_wrapper.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("rtl/neuron_wrapper.v", 1, "", "NBA region did not converge.");
            }
