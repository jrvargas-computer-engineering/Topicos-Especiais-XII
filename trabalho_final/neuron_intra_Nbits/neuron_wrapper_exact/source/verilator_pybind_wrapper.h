...
// "MAxPy_Vneuron_wrapper_exact" class
#pragma GCC visibility push(hidden)
class MAxPy_neuron_wrapper_exact : public neuron_wrapper_exact {
	public:
		MAxPy_neuron_wrapper_exact(const char* name);
		~MAxPy_neuron_wrapper_exact();
		void eval();
