...
neuron_wrapper_8neurons_DRUMs_8::neuron_wrapper_8neurons_DRUMs_8(VerilatedContext* _vcontextp__, const char* _vcname__)
    : VerilatedModel{*_vcontextp__}
    , vlSymsp{new neuron_wrapper_8neurons_DRUMs_8__Syms(contextp(), _vcname__, this)}
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
    , en{vlSymsp->TOP.en}
...
neuron_wrapper_8neurons_DRUMs_8::neuron_wrapper_8neurons_DRUMs_8(const char* _vcname__)
    : neuron_wrapper_8neurons_DRUMs_8(Verilated::threadContextp(), _vcname__)
{
}
...
neuron_wrapper_8neurons_DRUMs_8::~neuron_wrapper_8neurons_DRUMs_8() {
    delete vlSymsp;
}
...
void neuron_wrapper_8neurons_DRUMs_8::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate neuron_wrapper_8neurons_DRUMs_8::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
...
//============================================================
// Events and timing
bool neuron_wrapper_8neurons_DRUMs_8::eventsPending() { return false; }

uint64_t neuron_wrapper_8neurons_DRUMs_8::nextTimeSlot() {
...
const char* neuron_wrapper_8neurons_DRUMs_8::name() const {
    return vlSymsp->name();
}
...
VL_ATTR_COLD void neuron_wrapper_8neurons_DRUMs_8::final() {
...
const char* neuron_wrapper_8neurons_DRUMs_8::hierName() const { return vlSymsp->name(); }
const char* neuron_wrapper_8neurons_DRUMs_8::modelName() const { return "neuron_wrapper_8neurons_DRUMs_8"; }
unsigned neuron_wrapper_8neurons_DRUMs_8::threads() const { return 1; }
