...
#include "neuron_wrapper_8neurons_DRUMs_6.h"
#include "neuron_wrapper_8neurons_DRUMs_6__Syms.h"

//============================================================
// Constructors

neuron_wrapper_8neurons_DRUMs_6::neuron_wrapper_8neurons_DRUMs_6(VerilatedContext* _vcontextp__, const char* _vcname__)
    : VerilatedModel{*_vcontextp__}
    , vlSymsp{new neuron_wrapper_8neurons_DRUMs_6__Syms(contextp(), _vcname__, this)}
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
    , en{vlSymsp->TOP.en}
...
neuron_wrapper_8neurons_DRUMs_6::neuron_wrapper_8neurons_DRUMs_6(const char* _vcname__)
    : neuron_wrapper_8neurons_DRUMs_6(Verilated::threadContextp(), _vcname__)
{
}
...
neuron_wrapper_8neurons_DRUMs_6::~neuron_wrapper_8neurons_DRUMs_6() {
    delete vlSymsp;
}
...
void neuron_wrapper_8neurons_DRUMs_6::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate neuron_wrapper_8neurons_DRUMs_6::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
...
//============================================================
// Events and timing
bool neuron_wrapper_8neurons_DRUMs_6::eventsPending() { return false; }

uint64_t neuron_wrapper_8neurons_DRUMs_6::nextTimeSlot() {
...
const char* neuron_wrapper_8neurons_DRUMs_6::name() const {
    return vlSymsp->name();
}
...
VL_ATTR_COLD void neuron_wrapper_8neurons_DRUMs_6::final() {
...
const char* neuron_wrapper_8neurons_DRUMs_6::hierName() const { return vlSymsp->name(); }
const char* neuron_wrapper_8neurons_DRUMs_6::modelName() const { return "neuron_wrapper_8neurons_DRUMs_6"; }
unsigned neuron_wrapper_8neurons_DRUMs_6::threads() const { return 1; }
