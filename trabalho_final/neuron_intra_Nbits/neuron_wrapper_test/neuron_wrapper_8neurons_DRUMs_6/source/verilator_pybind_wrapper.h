...
// "MAxPy_Vneuron_wrapper_8neurons_DRUMs_6" class
#pragma GCC visibility push(hidden)
class MAxPy_neuron_wrapper_8neurons_DRUMs_6 : public neuron_wrapper_8neurons_DRUMs_6 {
	public:
		MAxPy_neuron_wrapper_8neurons_DRUMs_6(const char* name);
		~MAxPy_neuron_wrapper_8neurons_DRUMs_6();
		void eval();
