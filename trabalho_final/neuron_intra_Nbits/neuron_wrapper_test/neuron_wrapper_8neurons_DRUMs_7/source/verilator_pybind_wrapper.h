...
// "MAxPy_Vneuron_wrapper_8neurons_DRUMs_7" class
#pragma GCC visibility push(hidden)
class MAxPy_neuron_wrapper_8neurons_DRUMs_7 : public neuron_wrapper_8neurons_DRUMs_7 {
	public:
		MAxPy_neuron_wrapper_8neurons_DRUMs_7(const char* name);
		~MAxPy_neuron_wrapper_8neurons_DRUMs_7();
		void eval();
