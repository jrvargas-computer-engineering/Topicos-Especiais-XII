...
#include "neuron_wrapper_8neurons_DRUMs_7.h"
#include "neuron_wrapper_8neurons_DRUMs_7__Syms.h"

//============================================================
// Constructors

neuron_wrapper_8neurons_DRUMs_7::neuron_wrapper_8neurons_DRUMs_7(VerilatedContext* _vcontextp__, const char* _vcname__)
    : VerilatedModel{*_vcontextp__}
    , vlSymsp{new neuron_wrapper_8neurons_DRUMs_7__Syms(contextp(), _vcname__, this)}
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
    , en{vlSymsp->TOP.en}
...
neuron_wrapper_8neurons_DRUMs_7::neuron_wrapper_8neurons_DRUMs_7(const char* _vcname__)
    : neuron_wrapper_8neurons_DRUMs_7(Verilated::threadContextp(), _vcname__)
{
}
...
neuron_wrapper_8neurons_DRUMs_7::~neuron_wrapper_8neurons_DRUMs_7() {
    delete vlSymsp;
}
...
void neuron_wrapper_8neurons_DRUMs_7::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate neuron_wrapper_8neurons_DRUMs_7::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
...
//============================================================
// Events and timing
bool neuron_wrapper_8neurons_DRUMs_7::eventsPending() { return false; }

uint64_t neuron_wrapper_8neurons_DRUMs_7::nextTimeSlot() {
...
const char* neuron_wrapper_8neurons_DRUMs_7::name() const {
    return vlSymsp->name();
}
...
VL_ATTR_COLD void neuron_wrapper_8neurons_DRUMs_7::final() {
...
const char* neuron_wrapper_8neurons_DRUMs_7::hierName() const { return vlSymsp->name(); }
const char* neuron_wrapper_8neurons_DRUMs_7::modelName() const { return "neuron_wrapper_8neurons_DRUMs_7"; }
unsigned neuron_wrapper_8neurons_DRUMs_7::threads() const { return 1; }
