...
#ifndef VERILATED_NEURON_WRAPPER_8NEURONS_DRUMS_7__SYMS_H_
#define VERILATED_NEURON_WRAPPER_8NEURONS_DRUMS_7__SYMS_H_  // guard
...
class neuron_wrapper_8neurons_DRUMs_7__Syms final : public VerilatedSyms {
  public:
    // INTERNAL STATE
    neuron_wrapper_8neurons_DRUMs_7* const __Vm_modelp;
    ...
    // CONSTRUCTORS
    neuron_wrapper_8neurons_DRUMs_7__Syms(VerilatedContext* contextp, const char* namep, neuron_wrapper_8neurons_DRUMs_7* modelp);
    ~neuron_wrapper_8neurons_DRUMs_7__Syms();
