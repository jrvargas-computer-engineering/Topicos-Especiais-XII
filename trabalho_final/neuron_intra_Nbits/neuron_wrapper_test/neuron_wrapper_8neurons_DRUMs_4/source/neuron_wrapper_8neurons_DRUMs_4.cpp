...
neuron_wrapper_8neurons_DRUMs_4::neuron_wrapper_8neurons_DRUMs_4(VerilatedContext* _vcontextp__, const char* _vcname__)
    : VerilatedModel{*_vcontextp__}
    , vlSymsp{new neuron_wrapper_8neurons_DRUMs_4__Syms(contextp(), _vcname__, this)}
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
    , en{vlSymsp->TOP.en}
...
neuron_wrapper_8neurons_DRUMs_4::neuron_wrapper_8neurons_DRUMs_4(const char* _vcname__)
    : neuron_wrapper_8neurons_DRUMs_4(Verilated::threadContextp(), _vcname__)
{
}
...
neuron_wrapper_8neurons_DRUMs_4::~neuron_wrapper_8neurons_DRUMs_4() {
    delete vlSymsp;
}
...
void neuron_wrapper_8neurons_DRUMs_4::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate neuron_wrapper_8neurons_DRUMs_4::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
...
//============================================================
// Events and timing
bool neuron_wrapper_8neurons_DRUMs_4::eventsPending() { return false; }

uint64_t neuron_wrapper_8neurons_DRUMs_4::nextTimeSlot() {
...
const char* neuron_wrapper_8neurons_DRUMs_4::name() const {
    return vlSymsp->name();
}
...
VL_ATTR_COLD void neuron_wrapper_8neurons_DRUMs_4::final() {
...
const char* neuron_wrapper_8neurons_DRUMs_4::hierName() const { return vlSymsp->name(); }
const char* neuron_wrapper_8neurons_DRUMs_4::modelName() const { return "neuron_wrapper_8neurons_DRUMs_4"; }
unsigned neuron_wrapper_8neurons_DRUMs_4::threads() const { return 1; }
