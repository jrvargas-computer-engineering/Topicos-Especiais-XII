...
VL_INLINE_OPT void sub_LOBA1s__N10___nba_sequent__TOP__neuron_wrapper_2neurons__DOT__neuron1__DOT__u_neuron__DOT__mults__BRA__3__KET____DOT__mult_i__0(sub_LOBA1s__N10* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    neuron_wrapper_2neurons_LOBA1s_4__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            sub_LOBA1s__N10___nba_sequent__TOP__neuron_wrapper_2neurons__DOT__neuron1__DOT__u_neuron__DOT__mults__BRA__3__KET____DOT__mult_i__0\n"); );
    // Init
