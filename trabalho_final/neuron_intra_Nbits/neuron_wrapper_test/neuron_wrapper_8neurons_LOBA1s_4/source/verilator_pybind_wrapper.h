...
// "MAxPy_Vneuron_wrapper_8neurons_LOBA1s_4" class
#pragma GCC visibility push(hidden)
class MAxPy_neuron_wrapper_8neurons_LOBA1s_4 : public neuron_wrapper_8neurons_LOBA1s_4 {
	public:
		MAxPy_neuron_wrapper_8neurons_LOBA1s_4(const char* name);
		~MAxPy_neuron_wrapper_8neurons_LOBA1s_4();
		void eval();
