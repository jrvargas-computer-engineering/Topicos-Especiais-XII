...
// "MAxPy_Vneuron_wrapper_2neurons_LOBA1s_8" class
#pragma GCC visibility push(hidden)
class MAxPy_neuron_wrapper_2neurons_LOBA1s_8 : public neuron_wrapper_2neurons_LOBA1s_8 {
	public:
		MAxPy_neuron_wrapper_2neurons_LOBA1s_8(const char* name);
		~MAxPy_neuron_wrapper_2neurons_LOBA1s_8();
		void eval();
		...
		Instance* maxpy_neuron_wrapper_2neurons();
