...
#ifndef VERILATED_SUB_LOBA1S__N10_K8_H_
#define VERILATED_SUB_LOBA1S__N10_K8_H_  // guard

#include "verilated.h"

class neuron_wrapper_2neurons_LOBA1s_8__Syms;

class sub_LOBA1s__N10_K8 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    sub_LOBA1s__N10_K8(neuron_wrapper_2neurons_LOBA1s_8__Syms* symsp, const char* name);
    ~sub_LOBA1s__N10_K8();
    VL_UNCOPYABLE(sub_LOBA1s__N10_K8);
