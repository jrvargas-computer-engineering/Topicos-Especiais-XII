...
// "MAxPy_Vneuron_wrapper_8neurons_DRUMs_5" class
#pragma GCC visibility push(hidden)
class MAxPy_neuron_wrapper_8neurons_DRUMs_5 : public neuron_wrapper_8neurons_DRUMs_5 {
	public:
		MAxPy_neuron_wrapper_8neurons_DRUMs_5(const char* name);
		~MAxPy_neuron_wrapper_8neurons_DRUMs_5();
		void eval();
