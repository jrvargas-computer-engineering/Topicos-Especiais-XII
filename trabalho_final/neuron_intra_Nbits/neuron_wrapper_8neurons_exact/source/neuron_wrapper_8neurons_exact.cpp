...
#include "neuron_wrapper_8neurons_exact__Syms.h"

//============================================================
// Constructors

neuron_wrapper_8neurons_exact::neuron_wrapper_8neurons_exact(VerilatedContext* _vcontextp__, const char* _vcname__)
    : VerilatedModel{*_vcontextp__}
    , vlSymsp{new neuron_wrapper_8neurons_exact__Syms(contextp(), _vcname__, this)}
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
    , en{vlSymsp->TOP.en}
...
neuron_wrapper_8neurons_exact::neuron_wrapper_8neurons_exact(const char* _vcname__)
    : neuron_wrapper_8neurons_exact(Verilated::threadContextp(), _vcname__)
{
}
...
neuron_wrapper_8neurons_exact::~neuron_wrapper_8neurons_exact() {
    delete vlSymsp;
}
...
void neuron_wrapper_8neurons_exact::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate neuron_wrapper_8neurons_exact::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
...
//============================================================
// Events and timing
bool neuron_wrapper_8neurons_exact::eventsPending() { return false; }

uint64_t neuron_wrapper_8neurons_exact::nextTimeSlot() {
...
const char* neuron_wrapper_8neurons_exact::name() const {
    return vlSymsp->name();
}
...
VL_ATTR_COLD void neuron_wrapper_8neurons_exact::final() {
...
const char* neuron_wrapper_8neurons_exact::hierName() const { return vlSymsp->name(); }
const char* neuron_wrapper_8neurons_exact::modelName() const { return "neuron_wrapper_8neurons_exact"; }
unsigned neuron_wrapper_8neurons_exact::threads() const { return 1; }
