...
// "MAxPy_Vneuron_intra_Nbits_DRUMs_8" class
#pragma GCC visibility push(hidden)
class MAxPy_neuron_intra_Nbits_DRUMs_8 : public neuron_intra_Nbits_DRUMs_8 {
	public:
		MAxPy_neuron_intra_Nbits_DRUMs_8(const char* name);
		~MAxPy_neuron_intra_Nbits_DRUMs_8();
		void eval();
