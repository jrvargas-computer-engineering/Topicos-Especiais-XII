...
// "MAxPy_Vneuron_intra_Nbits_DRUMs_4" class
#pragma GCC visibility push(hidden)
class MAxPy_neuron_intra_Nbits_DRUMs_4 : public neuron_intra_Nbits_DRUMs_4 {
	public:
		MAxPy_neuron_intra_Nbits_DRUMs_4(const char* name);
		~MAxPy_neuron_intra_Nbits_DRUMs_4();
		void eval();
		...
		Instance* maxpy_neuron_intra_Nbits();
