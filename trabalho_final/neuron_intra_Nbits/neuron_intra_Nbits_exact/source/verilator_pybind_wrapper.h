...
// "MAxPy_Vneuron_intra_Nbits_exact" class
#pragma GCC visibility push(hidden)
class MAxPy_neuron_intra_Nbits_exact : public neuron_intra_Nbits_exact {
	public:
		MAxPy_neuron_intra_Nbits_exact(const char* name);
		~MAxPy_neuron_intra_Nbits_exact();
		void eval();
