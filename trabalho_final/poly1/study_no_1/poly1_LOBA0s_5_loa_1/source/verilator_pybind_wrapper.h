...
// "MAxPy_Vpoly1_LOBA0s_5_loa_1" class
#pragma GCC visibility push(hidden)
class MAxPy_poly1_LOBA0s_5_loa_1 : public poly1_LOBA0s_5_loa_1 {
	public:
		MAxPy_poly1_LOBA0s_5_loa_1(const char* name);
		~MAxPy_poly1_LOBA0s_5_loa_1();
		void eval();
