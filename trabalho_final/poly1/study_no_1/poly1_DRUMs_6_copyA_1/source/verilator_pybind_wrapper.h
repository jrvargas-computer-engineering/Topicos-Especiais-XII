...
// "MAxPy_Vpoly1_DRUMs_6_copyA_1" class
#pragma GCC visibility push(hidden)
class MAxPy_poly1_DRUMs_6_copyA_1 : public poly1_DRUMs_6_copyA_1 {
	public:
		MAxPy_poly1_DRUMs_6_copyA_1(const char* name);
		~MAxPy_poly1_DRUMs_6_copyA_1();
		void eval();
