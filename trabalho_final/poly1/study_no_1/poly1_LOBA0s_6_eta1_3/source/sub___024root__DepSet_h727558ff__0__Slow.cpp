...
#endif
                VL_FATAL_MT("study_no_1/poly1_LOBA0s_6_eta1_3/rtl/poly1.v", 1, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void sub___024root___ctor_var_reset(sub___024root* vlSelf) {
    ...
    vlSelf->poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD = VL_RAND_RESET_I(3);
    ...
    vlSelf->__Vtrigrprev__TOP__poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD = VL_RAND_RESET_I(3);
