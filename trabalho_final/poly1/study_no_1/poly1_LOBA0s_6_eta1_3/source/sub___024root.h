...
class sub___024root final : public VerilatedModule {
  public:
    ...
    CData/*2:0*/ poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD;
    ...
    CData/*2:0*/ __Vtrigrprev__TOP__poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD;
    ...
    // CONSTRUCTORS
    sub___024root(poly1_LOBA0s_6_eta1_3__Syms* symsp, const char* name);
    ~sub___024root();
