...
#endif
                VL_FATAL_MT("study_no_1/poly1_LOBA0s_4_eta1_4/rtl/poly1.v", 1, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void sub___024root___dump_triggers__stl(sub___024root* vlSelf) {
    ...
    if (vlSelf->__VstlTriggered.at(1U)) {
        VL_DBG_MSGF("         'stl' region trigger index 1 is active: @([hybrid] poly1.sum1.genblk1.SET_CMD)\n");
    }
}
#endif  // VL_DEBUG

void sub___024root___ico_sequent__TOP__0(sub___024root* vlSelf);
void sub___024root___ico_comb__TOP__0(sub___024root* vlSelf);
...
VL_ATTR_COLD void sub___024root___dump_triggers__ico(sub___024root* vlSelf) {
    ...
    if (vlSelf->__VicoTriggered.at(1U)) {
        VL_DBG_MSGF("         'ico' region trigger index 1 is active: @([hybrid] poly1.sum1.genblk1.SET_CMD)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void sub___024root___dump_triggers__act(sub___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(0U)) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @([hybrid] poly1.sum1.genblk1.SET_CMD)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void sub___024root___dump_triggers__nba(sub___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(0U)) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @([hybrid] poly1.sum1.genblk1.SET_CMD)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void sub___024root___ctor_var_reset(sub___024root* vlSelf) {
    ...
    vlSelf->poly1__DOT____Vcellout__mult1____pinNumber3 = VL_RAND_RESET_I(32);
    vlSelf->poly1__DOT__mult1__DOT__u1__DOT__k1a = VL_RAND_RESET_I(4);
    vlSelf->poly1__DOT__mult1__DOT__u1__DOT__k1b = VL_RAND_RESET_I(4);
    vlSelf->poly1__DOT__mult1__DOT__u1__DOT__u1__DOT__lobh = VL_RAND_RESET_I(16);
    vlSelf->poly1__DOT__mult1__DOT__u1__DOT__u1__DOT__u1__DOT__w = VL_RAND_RESET_I(16);
    vlSelf->poly1__DOT__mult1__DOT__u1__DOT__u2__DOT__lobh = VL_RAND_RESET_I(16);
    vlSelf->poly1__DOT__mult1__DOT__u1__DOT__u2__DOT__u1__DOT__w = VL_RAND_RESET_I(16);
    vlSelf->poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD = VL_RAND_RESET_I(4);
    vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_he1bff56f__0 = 0;
    vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_hec611698__0 = 0;
    vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_h99057765__0 = 0;
    vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_h969f8589__0 = 0;
    vlSelf->__Vtrigrprev__TOP__poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD = VL_RAND_RESET_I(4);
