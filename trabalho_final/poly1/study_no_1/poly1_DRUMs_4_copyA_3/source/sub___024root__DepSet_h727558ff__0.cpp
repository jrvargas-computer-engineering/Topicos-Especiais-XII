...
// See poly1_DRUMs_4_copyA_3.h for the primary calling header
...
VL_INLINE_OPT void sub___024root___ico_sequent__TOP__0(sub___024root* vlSelf) {
    ...
    poly1_DRUMs_4_copyA_3__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    ...
    poly1__DOT____Vcellout__mult1____pinNumber3 = (
                                                   ...
                                                   ((IData)(1U) 
                                                    ...
                                                    : poly1__DOT__mult1__DOT__r_temp);
    vlSelf->y = ((0xfff8U & (((poly1__DOT____Vcellout__mult1____pinNumber3 
                               >> 3U) + (0x1fffU & 
                                         (VL_EXTENDS_II(16,8, (IData)(vlSelf->b)) 
                                          >> 3U))) 
                             << 3U)) | (7U & poly1__DOT____Vcellout__mult1____pinNumber3));
}
...
#endif
                VL_FATAL_MT("study_no_1/poly1_DRUMs_4_copyA_3/rtl/poly1.v", 1, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("study_no_1/poly1_DRUMs_4_copyA_3/rtl/poly1.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("study_no_1/poly1_DRUMs_4_copyA_3/rtl/poly1.v", 1, "", "NBA region did not converge.");
            }
