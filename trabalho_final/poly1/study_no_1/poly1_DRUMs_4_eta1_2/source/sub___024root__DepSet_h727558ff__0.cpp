...
VL_INLINE_OPT void sub___024root___ico_comb__TOP__0(sub___024root* vlSelf) {
    ...
    vlSelf->poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD 
        = (((IData)(vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_h99057765__0) 
            << 1U) | (1U & (((IData)(vlSelf->poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD) 
                             >> 1U) | (0xffffU & (vlSelf->poly1__DOT____Vcellout__mult1____pinNumber3 
                                                  & VL_EXTENDS_II(16,8, (IData)(vlSelf->b)))))));
    vlSelf->y = ((0xfffcU & (((vlSelf->poly1__DOT____Vcellout__mult1____pinNumber3 
                               >> 2U) + (0x3fffU & 
                                         (VL_EXTENDS_II(16,8, (IData)(vlSelf->b)) 
                                          >> 2U))) 
                             << 2U)) | (((IData)((((IData)(vlSelf->poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD) 
                                                   >> 1U) 
                                                  | (IData)(vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_h99057765__0))) 
                                         << 1U) | (1U 
...
#endif
                VL_FATAL_MT("study_no_1/poly1_DRUMs_4_eta1_2/rtl/poly1.v", 1, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("study_no_1/poly1_DRUMs_4_eta1_2/rtl/poly1.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("study_no_1/poly1_DRUMs_4_eta1_2/rtl/poly1.v", 1, "", "NBA region did not converge.");
            }
