...
// "MAxPy_Vpoly1_DRUMs_5_loa_2" class
#pragma GCC visibility push(hidden)
class MAxPy_poly1_DRUMs_5_loa_2 : public poly1_DRUMs_5_loa_2 {
	public:
		MAxPy_poly1_DRUMs_5_loa_2(const char* name);
		~MAxPy_poly1_DRUMs_5_loa_2();
		void eval();
