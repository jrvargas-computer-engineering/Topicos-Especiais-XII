...
// "MAxPy_Vpoly1_DRUMs_6_eta1_3" class
#pragma GCC visibility push(hidden)
class MAxPy_poly1_DRUMs_6_eta1_3 : public poly1_DRUMs_6_eta1_3 {
	public:
		MAxPy_poly1_DRUMs_6_eta1_3(const char* name);
		~MAxPy_poly1_DRUMs_6_eta1_3();
		void eval();
