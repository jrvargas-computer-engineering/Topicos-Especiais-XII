...
// "MAxPy_Vpoly1_LOBA0s_4_loa_3" class
#pragma GCC visibility push(hidden)
class MAxPy_poly1_LOBA0s_4_loa_3 : public poly1_LOBA0s_4_loa_3 {
	public:
		MAxPy_poly1_LOBA0s_4_loa_3(const char* name);
		~MAxPy_poly1_LOBA0s_4_loa_3();
		void eval();
