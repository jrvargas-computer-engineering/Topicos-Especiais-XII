...
VL_INLINE_OPT void sub___024root___ico_sequent__TOP__0(sub___024root* vlSelf) {
    ...
    poly1_DRUMs_4_loa_2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
#endif
                VL_FATAL_MT("study_no_1/poly1_DRUMs_4_loa_2/rtl/poly1.v", 1, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("study_no_1/poly1_DRUMs_4_loa_2/rtl/poly1.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("study_no_1/poly1_DRUMs_4_loa_2/rtl/poly1.v", 1, "", "NBA region did not converge.");
            }
