...
void sub___024root___eval_triggers__ico(sub___024root* vlSelf) {
    ...
    vlSelf->__VicoTriggered.at(1U) = ((IData)(vlSelf->poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD) 
...
void sub___024root___eval_triggers__act(sub___024root* vlSelf) {
    ...
    // Body
    vlSelf->__VactTriggered.at(0U) = ((IData)(vlSelf->poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD) 
                                      != (IData)(vlSelf->__Vtrigrprev__TOP__poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD));
    vlSelf->__Vtrigrprev__TOP__poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD 
        = vlSelf->poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD;
