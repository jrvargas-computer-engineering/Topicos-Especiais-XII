...
// "MAxPy_Vpoly1_DRUMs_4_eta1_4" class
#pragma GCC visibility push(hidden)
class MAxPy_poly1_DRUMs_4_eta1_4 : public poly1_DRUMs_4_eta1_4 {
	public:
		MAxPy_poly1_DRUMs_4_eta1_4(const char* name);
		~MAxPy_poly1_DRUMs_4_eta1_4();
		void eval();
