...
// See poly1_DRUMs_4_eta1_4.h for the primary calling header
...
VL_INLINE_OPT void sub___024root___ico_sequent__TOP__0(sub___024root* vlSelf) {
    ...
    poly1_DRUMs_4_eta1_4__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    ...
    CData/*1:0*/ poly1__DOT__mult1__DOT__U1__DOT__m;
    CData/*1:0*/ poly1__DOT__mult1__DOT__U1__DOT__n;
    ...
    if ((4U == (IData)(poly1__DOT__mult1__DOT__U1__DOT__k1))) {
        poly1__DOT__mult1__DOT__U1__DOT__n = (3U & 
                                              (__VdfgTmp_h734707d0__0 
                                               >> 2U));
    }
    if ((5U == (IData)(poly1__DOT__mult1__DOT__U1__DOT__k1))) {
        poly1__DOT__mult1__DOT__U1__DOT__n = (3U & 
                                              (__VdfgTmp_h734707d0__0 
                                               >> 3U));
    }
    ...
    if ((4U == (IData)(poly1__DOT__mult1__DOT__U1__DOT__k2))) {
        poly1__DOT__mult1__DOT__U1__DOT__m = (3U & 
                                              (__VdfgTmp_h61254020__0 
                                               >> 2U));
    }
    if ((5U == (IData)(poly1__DOT__mult1__DOT__U1__DOT__k2))) {
        poly1__DOT__mult1__DOT__U1__DOT__m = (3U & 
                                              (__VdfgTmp_h61254020__0 
                                               >> 3U));
    }
    ...
    poly1__DOT__mult1__DOT__r_temp = ((0xffU & ((0xfU 
                                                 & ((3U 
                                                   ...
                                                   ((3U 
                                                    ...
                                                    (0xfU 
                                                     & ((IData)(poly1__DOT__mult1__DOT__U1__DOT__k2) 
                                                        - (IData)(3U)))
                                                     : 0U))));
    vlSelf->poly1__DOT____Vcellout__mult1____pinNumber3 
        = ((1U & ((1U & (VL_EXTENDS_II(16,8, (IData)(vlSelf->a)) 
                         >> 0xfU)) ^ (1U & (VL_EXTENDS_II(16,8, (IData)(vlSelf->x)) 
                                            >> 0xfU))))
            ? ((IData)(1U) + (~ poly1__DOT__mult1__DOT__r_temp))
            : poly1__DOT__mult1__DOT__r_temp);
    vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_hec611698__0 
        = (1U & ((vlSelf->poly1__DOT____Vcellout__mult1____pinNumber3 
                  >> 2U) ^ (0x3fffU & (VL_EXTENDS_II(16,8, (IData)(vlSelf->b)) 
                                       >> 2U))));
    vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_h99057765__0 
        = (1U & ((vlSelf->poly1__DOT____Vcellout__mult1____pinNumber3 
                  >> 1U) ^ (0x7fffU & (VL_EXTENDS_II(16,8, (IData)(vlSelf->b)) 
                                       >> 1U))));
    vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_h969f8589__0 
        = (1U & (vlSelf->poly1__DOT____Vcellout__mult1____pinNumber3 
                 ^ (0xffffU & VL_EXTENDS_II(16,8, (IData)(vlSelf->b)))));
    vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_he1bff56f__0 
        = (1U & ((vlSelf->poly1__DOT____Vcellout__mult1____pinNumber3 
                  >> 3U) ^ (0x1fffU & (VL_EXTENDS_II(16,8, (IData)(vlSelf->b)) 
                                       >> 3U))));
}

VL_INLINE_OPT void sub___024root___ico_comb__TOP__0(sub___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    poly1_DRUMs_4_eta1_4__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    sub___024root___ico_comb__TOP__0\n"); );
    // Body
    vlSelf->poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD 
        = (((IData)(vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_he1bff56f__0) 
            << 3U) | (7U & (((IData)(vlSelf->poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD) 
                             >> 1U) | (0xffffU & (vlSelf->poly1__DOT____Vcellout__mult1____pinNumber3 
                                                  & VL_EXTENDS_II(16,8, (IData)(vlSelf->b)))))));
    vlSelf->y = ((0xfff0U & (((vlSelf->poly1__DOT____Vcellout__mult1____pinNumber3 
                               >> 4U) + (0xfffU & (
                                                   VL_EXTENDS_II(16,8, (IData)(vlSelf->b)) 
                                                   >> 4U))) 
                             << 4U)) | (((IData)((((IData)(vlSelf->poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD) 
                                                   >> 3U) 
                                                  | (IData)(vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_he1bff56f__0))) 
                                         << 3U) | (
                                                   (4U 
                                                    & ((0xfffffffcU 
                                                        & (IData)(vlSelf->poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD)) 
                                                       | ((IData)(vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_hec611698__0) 
                                                          << 2U))) 
                                                   | ((2U 
                                                       & ((0xfffffffeU 
                                                           & (IData)(vlSelf->poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD)) 
                                                          | ((IData)(vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_h99057765__0) 
                                                             << 1U))) 
                                                      | (1U 
                                                         & ((IData)(vlSelf->poly1__DOT__sum1__DOT__genblk1__DOT__SET_CMD) 
                                                            | (IData)(vlSelf->poly1__DOT__sum1__DOT____VdfgTmp_h969f8589__0)))))));
}
...
void sub___024root___eval_ico(sub___024root* vlSelf) {
    ...
    if ((vlSelf->__VicoTriggered.at(0U) | vlSelf->__VicoTriggered.at(1U))) {
        sub___024root___ico_comb__TOP__0(vlSelf);
    }
}
...
#endif
                VL_FATAL_MT("study_no_1/poly1_DRUMs_4_eta1_4/rtl/poly1.v", 1, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("study_no_1/poly1_DRUMs_4_eta1_4/rtl/poly1.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("study_no_1/poly1_DRUMs_4_eta1_4/rtl/poly1.v", 1, "", "NBA region did not converge.");
            }
