...
// See poly1_DRUMs_4_trunc0_1.h for the primary calling header
...
VL_INLINE_OPT void sub___024root___ico_sequent__TOP__0(sub___024root* vlSelf) {
    ...
    poly1_DRUMs_4_trunc0_1__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
                                                   ...
                                                   ((3U 
                                                    ...
                                                    (0xfU 
                                                     & ((IData)(poly1__DOT__mult1__DOT__U1__DOT__k2) 
                                                        - (IData)(3U)))
                                                     : 0U))));
    vlSelf->y = (0xffffU & (((0x7fffU & (((1U & ((1U 
                                                  & (VL_EXTENDS_II(16,8, (IData)(vlSelf->a)) 
                                                     >> 0xfU)) 
                                                 ^ 
                                                 (1U 
                                           ...
                                           : poly1__DOT__mult1__DOT__r_temp) 
                                         >> 1U)) + 
                             (0x7fffU & (VL_EXTENDS_II(16,8, (IData)(vlSelf->b)) 
                                         >> 1U))) << 1U));
}
...
#endif
                VL_FATAL_MT("study_no_1/poly1_DRUMs_4_trunc0_1/rtl/poly1.v", 1, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("study_no_1/poly1_DRUMs_4_trunc0_1/rtl/poly1.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("study_no_1/poly1_DRUMs_4_trunc0_1/rtl/poly1.v", 1, "", "NBA region did not converge.");
            }
