...
// "MAxPy_Vpoly1_LOBA0s_5_loa_4" class
#pragma GCC visibility push(hidden)
class MAxPy_poly1_LOBA0s_5_loa_4 : public poly1_LOBA0s_5_loa_4 {
	public:
		MAxPy_poly1_LOBA0s_5_loa_4(const char* name);
		~MAxPy_poly1_LOBA0s_5_loa_4();
		void eval();
