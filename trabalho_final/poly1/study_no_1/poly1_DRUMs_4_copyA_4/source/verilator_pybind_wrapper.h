...
// "MAxPy_Vpoly1_DRUMs_4_copyA_4" class
#pragma GCC visibility push(hidden)
class MAxPy_poly1_DRUMs_4_copyA_4 : public poly1_DRUMs_4_copyA_4 {
	public:
		MAxPy_poly1_DRUMs_4_copyA_4(const char* name);
		~MAxPy_poly1_DRUMs_4_copyA_4();
		void eval();
